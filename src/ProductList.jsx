...
import { addItem, incrementCartNumber } from './CartSlice';
                            ...
                            <div className="product-list" key={index}>
                                {category.plants.map((plant, index) => (
                                    <div className="product-card" key={index}>
                                        ...
                                        <button disabled={addedToCart[plant.name]} className={addedToCart[plant.name] ? 'product-button added-to-cart' : 'product-button' } onClick={() => handleAddToCart(plant)}>
